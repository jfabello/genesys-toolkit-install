...
GO_VERSION="1.21.1" # Go version to be installed
...
CLI_VERSION="80.1.0" # Genesys Cloud CLI version to be installed
...
TERRAFORM_VERSION="1.5.6" # Terraform version to be installed
